...
$route['studyspaces/reserve']['POST'] = 'studyspaces/reserve'; // I can access users/reserve while logged in (because it checks whether I am logged in or not) without this
