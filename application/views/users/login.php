        ...
        <div class="grid">
            ...
            <form action="<?php echo $url; ?>" method="POST" class="form login">
                ...
                <div class="form__field">
                    ...
                    <input id="login__email" type="text" name="email" class="form__input browser-default"
                ...
                <div class="form__field">
                    ...
                    <input id="login__password" type="password" name="password" class="form__input browser-default"
